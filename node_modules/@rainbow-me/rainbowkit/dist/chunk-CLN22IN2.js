  ...
  return /* @__PURE__ */ React8.createElement(RainbowKitChainContext.Provider, {
    value: useMemo3(() => {
      ...
      return {
        ...
        initialChainId: typeof initialChain === "number" ? initialChain : (_b = initialChain == null ? void 0 : initialChain.id) != null ? _b : (_a = chains[0]) == null ? void 0 : _a.id
      };
    }, [chains, initialChain])
  }, children);
}
...
function Dialog({ children, onClose, open, titleId }) {
  ...
  return /* @__PURE__ */ React15.createElement(React15.Fragment, null, open ? createPortal(/* @__PURE__ */ React15.createElement(RemoveScroll, null, /* @__PURE__ */ React15.createElement(Box, {
    ...themeRootProps
...
import React29, { useCallback as useCallback5, useContext as useContext6, useEffect as useEffect9, useState as useState4 } from "react";
...
function ProfileDetails({
  ...
  const [copiedAddress, setCopiedAddress] = useState4(false);
...
function ChainModal({ onClose, open }) {
  ...
  const [switchingToChain, setSwitchingToChain] = useState5();
...
import React44, { Fragment as Fragment2, useEffect as useEffect14, useState as useState8 } from "react";
...
import React39, { useState as useState6 } from "react";
...
import React45, { useCallback as useCallback7, useContext as useContext10, useState as useState9 } from "react";
