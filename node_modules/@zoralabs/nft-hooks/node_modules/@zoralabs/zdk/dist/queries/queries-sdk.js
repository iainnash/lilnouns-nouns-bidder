...
var V1MarketEntityStatus;
(function (V1MarketEntityStatus) {
    V1MarketEntityStatus["Active"] = "ACTIVE";
    V1MarketEntityStatus["Canceled"] = "CANCELED";
    V1MarketEntityStatus["Completed"] = "COMPLETED";
})(V1MarketEntityStatus = exports.V1MarketEntityStatus || (exports.V1MarketEntityStatus = {}));
...
var V2AuctionStatus;
(function (V2AuctionStatus) {
    V2AuctionStatus["Active"] = "ACTIVE";
    V2AuctionStatus["Canceled"] = "CANCELED";
    V2AuctionStatus["Completed"] = "COMPLETED";
    V2AuctionStatus["Expired"] = "EXPIRED";
})(V2AuctionStatus = exports.V2AuctionStatus || (exports.V2AuctionStatus = {}));
var V3AskEventType;
...
var V3AskStatus;
(function (V3AskStatus) {
    V3AskStatus["Active"] = "ACTIVE";
    V3AskStatus["Canceled"] = "CANCELED";
    V3AskStatus["Completed"] = "COMPLETED";
