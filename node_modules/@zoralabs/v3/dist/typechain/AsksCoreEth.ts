...
export interface AsksCoreEthInterface extends utils.Interface {
  functions: {
    ...
    "createAsk(address,uint256,uint256)": FunctionFragment;
  ...
  events: {
    "AskCanceled(address,uint256,address,uint256)": EventFragment;
    "AskCreated(address,uint256,address,uint256)": EventFragment;
    "AskFilled(address,uint256,address,address,uint256)": EventFragment;
    "AskPriceUpdated(address,uint256,address,uint256)": EventFragment;
...
export interface AsksCoreEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AsksCoreEthInterface;
