...
export interface StorageTestBaseFullInterface extends utils.Interface {
  functions: {
    ...
    "updatePrice(address,uint256,address,uint256)": FunctionFragment;
  };
...
export interface StorageTestBaseFull extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: StorageTestBaseFullInterface;
