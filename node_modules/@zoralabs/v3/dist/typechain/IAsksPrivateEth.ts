...
export interface IAsksPrivateEthInterface extends utils.Interface {
  functions: {
...
export interface IAsksPrivateEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IAsksPrivateEthInterface;
