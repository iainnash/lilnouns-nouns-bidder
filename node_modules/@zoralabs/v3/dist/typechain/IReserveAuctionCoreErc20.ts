...
export interface IReserveAuctionCoreErc20Interface extends utils.Interface {
  functions: {
...
export interface IReserveAuctionCoreErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReserveAuctionCoreErc20Interface;
