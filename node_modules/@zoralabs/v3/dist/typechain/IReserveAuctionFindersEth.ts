...
export interface IReserveAuctionFindersEthInterface extends utils.Interface {
  functions: {
...
export interface IReserveAuctionFindersEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReserveAuctionFindersEthInterface;
