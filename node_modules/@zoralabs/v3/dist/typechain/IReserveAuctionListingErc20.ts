...
export interface IReserveAuctionListingErc20Interface extends utils.Interface {
  functions: {
    "cancelAuction(address,uint256)": FunctionFragment;
    "createAuction(address,uint256,uint256,uint256,address,uint256,address,uint256,address)": FunctionFragment;
...
export interface IReserveAuctionListingErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReserveAuctionListingErc20Interface;
