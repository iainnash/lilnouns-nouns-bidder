...
export interface IReserveAuctionListingEthInterface extends utils.Interface {
  functions: {
...
export interface IReserveAuctionListingEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IReserveAuctionListingEthInterface;
