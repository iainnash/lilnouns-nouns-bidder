...
export interface ReserveAuctionCoreEthInterface extends utils.Interface {
  functions: {
...
export type AuctionCanceledEvent = TypedEvent<
  [string, BigNumber, ReserveAuctionCoreEth.AuctionStructOutput],
...
export interface ReserveAuctionCoreEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveAuctionCoreEthInterface;
  ...
  functions: {
    ...
    auctionForNFT(
      ...
      [string, BigNumber, string, BigNumber, string, number, number, number] & {
        seller: string;
        reservePrice: BigNumber;
        sellerFundsRecipient: string;
        highestBid: BigNumber;
