...
export declare namespace ReserveAuctionFindersErc20 {
...
export interface ReserveAuctionFindersErc20Interface extends utils.Interface {
  functions: {
...
export interface AuctionBidEventObject {
  ...
  firstBid: boolean;
  extended: boolean;
  auction: ReserveAuctionFindersErc20.AuctionStructOutput;
}
export type AuctionBidEvent = TypedEvent<
  [
    ...
    boolean,
    boolean,
    ReserveAuctionFindersErc20.AuctionStructOutput
  ],
...
export type AuctionCanceledEvent = TypedEvent<
  [string, BigNumber, ReserveAuctionFindersErc20.AuctionStructOutput],
...
export interface ReserveAuctionFindersErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveAuctionFindersErc20Interface;
