...
export declare namespace ReserveAuctionFindersEth {
...
export interface ReserveAuctionFindersEthInterface extends utils.Interface {
  functions: {
    ...
    "createAuction(address,uint256,uint256,uint256,address,uint256,uint256)": FunctionFragment;
    "createBid(address,uint256,address)": FunctionFragment;
...
export interface AuctionBidEventObject {
  ...
  firstBid: boolean;
  extended: boolean;
  auction: ReserveAuctionFindersEth.AuctionStructOutput;
}
export type AuctionBidEvent = TypedEvent<
  [
    ...
    boolean,
    boolean,
    ReserveAuctionFindersEth.AuctionStructOutput
  ],
...
export type AuctionCanceledEvent = TypedEvent<
  [string, BigNumber, ReserveAuctionFindersEth.AuctionStructOutput],
...
export interface ReserveAuctionFindersEth extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveAuctionFindersEthInterface;
