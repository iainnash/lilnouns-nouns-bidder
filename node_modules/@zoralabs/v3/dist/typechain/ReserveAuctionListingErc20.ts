...
export declare namespace ReserveAuctionListingErc20 {
...
export interface ReserveAuctionListingErc20Interface extends utils.Interface {
  functions: {
...
export interface AuctionBidEventObject {
  ...
  firstBid: boolean;
  extended: boolean;
  auction: ReserveAuctionListingErc20.AuctionStructOutput;
}
export type AuctionBidEvent = TypedEvent<
  [
    ...
    boolean,
    boolean,
    ReserveAuctionListingErc20.AuctionStructOutput
  ],
...
export type AuctionCanceledEvent = TypedEvent<
  [string, BigNumber, ReserveAuctionListingErc20.AuctionStructOutput],
...
export interface ReserveAuctionListingErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ReserveAuctionListingErc20Interface;
